...
const PROMPT_SHOWN_KEY = 'newtone-center-feedback-prompt-shown-v1'
...
const SOURCES = new Set(['exit-prompt', 'phone'])
...
export const CENTER_FEEDBACK_STORAGE_KEYS = Object.freeze({ promptShown: PROMPT_SHOWN_KEY })
