...
const { FIRST_LANDING_LEAVE_MS, FIRST_ENTRY_EMPTY_HOLD_MS, RETURN_LANDING_LEAVE_MS, LANG_LEAVING_MS, MODE_LEAVING_MS, MIN_READER_MS, TRANSITION_FADE_MS } = READING_ENTRY_TIMINGS
