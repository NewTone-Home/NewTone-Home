-- Keep the analytics RPC invoker-only. Owner access is enforced by table RLS.
...
drop policy if exists center_feedback_owner_select on public.center_feedback_submissions;
create policy center_feedback_owner_select
...
begin
  return jsonb_build_object(
    ...
    'feedback', coalesce((
      ...
      from (
        select source, experience_length, portrait_adaptation, continuation_interest, free_text, created_at
