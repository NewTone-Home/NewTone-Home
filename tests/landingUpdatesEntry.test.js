...
describe('Landing updates entry', () => {
  ...
  it('returns complete arrows from the glitch source before the final direction turn', () => {
    ...
    expect(guideCss).toContain('.landing[data-updates-phase="return-arrows"] .landing-guide-entry-arrow')
    expect(guideCss).toContain('landing-updates-arrow-return 1400ms')
    expect(guideCss).not.toContain('.landing[data-updates-phase="return-arrows"] .landing-entry-arrow {')
