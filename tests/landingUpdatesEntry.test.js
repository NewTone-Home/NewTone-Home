...
describe('Landing updates entry', () => {
  ...
  it('keeps Updates and Reader entries in one shared click group', () => {
    ...
    expect(entryCss).toContain('.landing-entry-button-group .shared-entry-control:first-child')
    expect(entryCss).toContain('.landing-entry-button-group .shared-entry-control:last-child')
