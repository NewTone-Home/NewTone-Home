...
describe('portable Reader return control', () => {
  it('has a host-independent visual contract', () => {
    ...
    expect(control).toContain('hidden -> entering -> visible -> exiting -> hidden')
    expect(control).toContain('textEnter: 320')
    expect(control).toContain('frameEnter: 720')
    expect(control).toContain('textExit: 260')
    expect(control).toContain('frameExit: 420')
