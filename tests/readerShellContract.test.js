...
describe('Reader shell contract boundaries', () => {
  ...
  it('draws a compact Landing guide and erases it with a paper-colored pass', () => {
    ...
    expect(landingCss).toContain('left: .08em')
    expect(landingCss).toContain('bottom: .16em')
    expect(landingGuideCss).toContain('left: -46px')
    expect(landingGuideCss).toContain('width: 66px')
