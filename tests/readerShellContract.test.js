...
describe('Reader shell contract boundaries', () => {
  ...
  it('offers a click-only return choice at the real page end', () => {
    ...
    expect(returnControl).toContain('data-return-fill-direction')
    ...
    expect(returnControlCss).toContain('reader-return-surface')
  ...
  it('runs one explicit timeline from current progress and preserves exit order', () => {
    ...
    expect(returnControl).toContain('fillOpen: 520')
    expect(returnControl).toContain('textExit: 260')
    expect(returnControl).toContain('fillClose: 520')
    ...
    expect(returnControl).toContain("{ key: 'fill', to: 0, duration: TIMINGS.fillClose }")
    ...
    expect(returnControl).toContain('clipPath')
  })
  ...
  it('draws one random-origin frame and one random-direction world-layer fill', () => {
    expect(returnControl).toContain('const FILL_DIRECTIONS')
    expect(returnControl).toContain("'center'")
    expect(returnControl).toContain('const FRAME_ORIGINS')
    expect(returnControl).toContain('nextFillDirection(fillDirectionQueueRef.current)')
    expect(returnControl).toContain('frameOrigin: randomItem(FRAME_ORIGINS)')
    expect(returnControl).toContain('pathLength="1"')
    expect(returnControl).toContain('data-return-active={fillActive')
    expect(returnControlCss).toContain("data-return-world-layer='inner'")
    expect(returnControl).toContain('const MATERIALS')
    expect(returnControl).toContain('const shapeId')
    expect(returnControl).toContain('const fillClipId')
    expect(returnControl).toContain('<use')
    expect(returnControl).toContain('clipPath={`url(#${fillClipId})`}')
    expect(returnControlCss).toContain('reader-return-material')
    expect(returnControlCss).toContain('reader-return-material-edge')
    expect(returnControlCss).toContain('The SVG owns the surface geometry')
    expect(returnControlCss).toContain('z-index: 1')
    expect(returnControlCss).toContain('z-index: 2')
    expect(returnControl).not.toContain('reader-return-door')
    expect(returnControl).not.toContain('reader-return-space')
    expect(returnControlCss).not.toContain('reader-return-mask')
  })
