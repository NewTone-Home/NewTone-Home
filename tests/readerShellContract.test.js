...
describe('Reader shell contract boundaries', () => {
  ...
  it('offers the return choice at the real page end and at the final node on direct-input devices', () => {
    ...
    expect(stage).toContain('const returnVisible = !returnDismissed && (emptyDocument || readerAtBottom || (directReaderInput && finalNodeReached))')
    ...
    expect(stage).toContain('onDismissComplete={() => setReturnDismissed(true)}')
