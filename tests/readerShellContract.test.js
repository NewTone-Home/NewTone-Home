...
describe('Reader shell contract boundaries', () => {
  ...
  it('uses one shared click group for language and reading mode', () => {
    ...
    expect(transition).toContain('retracting={fading}')
    ...
    expect(landingIntro).toContain('TRANSITION_TITLE_RETRACT_MS = 400')
    expect(titleMark).toContain('retract({ duration: TRANSITION_TITLE_RETRACT_MS })')
  })
