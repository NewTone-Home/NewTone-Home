...
describe('Scene content workspace', () => {
  it('starts with an empty Story -> Chapter -> Scene workspace', () => {
    expect(EMPTY_WORKSPACE).toMatchObject({ schemaVersion: 2, storyId: 'main-reader', languages: ['zh', 'en', 'ja', 'ko', 'fr'], chapters: [] })
  })
  ...
  it('converts legacy pages into stable Scene IDs without paragraph mapping', () => {
    ...
    expect(normalized.chapters[0].scenes[0]).toMatchObject({ id: 'chapter_02_scene_01', content: { zh: '中文', en: 'English' } })
